...
<p> Plugin QGIS (v3.10) destiné aux porteurs de projets, bureau d'études et services de l'état. Il permet la mise en forme de la table attributaire de fichier Shape dans un format compatible avec l'outil national de géolocalisation mesures compensatoires des atteintes à la biodiversité GéoMCE.</br>
...
<p><span style="color: #000000;"><strong>Validit&eacute; de la g&eacute;om&eacute;trie</strong> : Ouvre le traitement "V&eacute;rifier la validit&eacute;". Permet de s'assurer que la g&eacute;om&eacute;trie ne pr&eacute;sente pas de probl&egrave;mes notamment les auto-intersections de polygones qui empechent l'ex&eacute;cution du plugin</span></p>
...
<p><strong>Mettre &agrave; jour une mesure existante dans G&eacute;oMCE&nbsp;</strong>: Option est r&eacute;serv&eacute;e aux agents ayant acc&egrave;s &agrave; G&eacute;oMCE.</p>
<p>Elle permet d'importer de nouvelles g&eacute;om&eacute;tries dans une mesure d&eacute;j&agrave; existante dans l'outil. Les g&eacute;om&eacute;tries et champs existants dans la base de donn&eacute;e sont conserv&eacute;es et ne peuvent &ecirc;tre modifier depuis cette extension.</p>
<p>Afin de r&eacute;aliser cette op&eacute;ration, <span style="text-decoration: underline;">il faut que le champ nom de la mesure &agrave; mettre &agrave; jour corresponde parfaitement au nom de la mesure existante dans G&eacute;oMCE</span> (en cas de diff&eacute;rence, une nouvelle mesure sera cr&eacute;e).</p>
<p>Dans G&eacute;oMCE, la mise &agrave; jour des g&eacute;om&eacute;tries d'une mesure s'effectue de mani&egrave;re similaire &agrave; un import standard.</p>
...
<p><span style="color: #000000;"><span style="text-decoration: underline;"><strong>Remarque</strong> </span>: cette fonctionalit&eacute; semble poser probl&egrave;me sur QGIS 3.4.5. Il est recommand&eacute; de ne pas l'utiliser si vous utilisez cette version du logiciel.</span></p>
