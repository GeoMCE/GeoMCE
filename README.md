...
<p> Plugin pour QGIS v3.10 assurant la mise en forme des fichiers shape dans un format compatible avec un import dans l'outil nationale de géolocalisation mesures compensatoires des atteintes à la biodiversité GéoMCE.</br>
