...
#les champs de saisi texte et listes deroulantes.Les caracteres speciaux sont remplaces par leurequivalant sans   
    ...
    def get_description(self):
        new_val_description = ''.join((c for c in unicodedata.normalize('NFD', self.dlg.description.toPlainText()) if unicodedata.category(c) != 'Mn'))
    ...
    def get_unite(self):
        numero_unite =[u'Annee',u'Mois',u'Jour']
...
#ouvre le dossier contenant les fichiers de lacouche a traiter...
    def dossier(self):
        if self.dlg.tampon.isChecked(): 
...
#permet de charger les fluw wfs du ceremadata qui alimentent geoportail
    def wfs(self):
